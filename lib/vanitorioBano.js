 ...
 * estándar de 100mm; el cuerpo mide H - 100mm. Con soporte 'suspendido' no
 * hay zócalo, así que H es directamente el alto del cuerpo colgado.
 *
...
const DEFAULTS = {
  ...
  hp: 100,       // altura de zócalo (estándar, solo si soporte = 'patas')
...
function piezasCuerpo(p) {
  const { A, P, e, colorInterior, sifon } = p;
