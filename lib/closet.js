...
function generarHerrajes(p, {
  ...
  herrajes.push({ tipo: 'tornillo_confirmat', cantidad: 8 + divisores.length * 4 + totalCajoneras * 4 + tornillosTravesanos }); // cuerpo + fijación de divisores + tapa de cada cajonera + travesaños traseros
