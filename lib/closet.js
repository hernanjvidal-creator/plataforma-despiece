...
// Se resta "e" adicional: la repisa se receza esa distancia desde el fondo
// (ver piezasRepisasSeccion) para no chocar con los travesaños traseros.
function profundidadRepisa(p) {
  if (p.tipoPuerta === 'corredera') return p.P - 80 - p.e;
  return profundidadCuerpo(p) - 20 - p.e;
}
