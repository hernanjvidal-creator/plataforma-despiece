...
function generarHerrajes(p, { totalPuertas, totalBaldas, numModulos }) {
  ...
  herrajes.push({ tipo: 'tornillo_confirmat / tornillo_1_5/8', cantidad: numModulos * 16 });

  // Uniones lateral con lateral (módulo con módulo vecino, y cada tapa
  // lateral con el lateral del módulo del extremo): tableros delgados
  // (15/18mm) cara contra canto, van con un tornillo más corto — 30mm, 6
  // por junta (3 alturas x 2, para repartir bien la carga a lo alto).
  ...
  herrajes.push({
    tipo: 'tornillo_30mm',
    cantidad: (juntasEntreModulos + juntasTapasLaterales) * TORNILLOS_POR_JUNTA_LATERAL,
  });
