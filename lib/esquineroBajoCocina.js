...
// Zócalo del brazo: panel frontal + retorno en el extremo exterior (no el
// que da a la esquina, que queda contra el otro brazo).
function generarZocaloBrazo(prefijo, ancho, p) {
  const { P, e, hp, r, colorExterior } = p;
