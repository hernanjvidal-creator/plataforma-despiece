 ...
 * nada. Va apoyado bajo en 4 topes de fieltro autoadhesivo (no en patas
...
function generarDespiece(paramsUsuario = {}) {
  ...
  notas.push('Pega los 4 topes de fieltro autoadhesivo bajo el mueble, uno en cada esquina, antes de ponerlo en su lugar final — así no raya el piso al moverlo y queda un poco más estable.');
...
function generarHerrajes(p) {
  ...
  herrajes.push({ tipo: 'tope_piso_fieltro', cantidad: 4 });
