...
// El ancho total de la despensa no es un dato que mande el cliente: se
// calcula acá como la suma real de las secciones (ver anchoTotal en el
// resultado). Acá siempre hay divisor entre secciones (no existe el caso
// "colgador puro" del closet que a veces se lo salta): con 1 sola sección,
// en cambio, no hay ningún divisor.
